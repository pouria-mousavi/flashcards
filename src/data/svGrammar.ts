...
export const SV_GRAMMAR: GrammarLesson[] = [
  {
    ...
    cheat: [
      ...
      { kind: 'note', text: 'Watch for group 2a verbs whose stem already ends in -r: the imperative and the present are then IDENTICAL — kör! → kör, hör! → hör, lär! → lär. Nothing is missing; -er just has nowhere to go.' },
  ...
  },
  {
    ...
    cheat: [
      {
        ...
        rows: [
          ...
          ['your (one person)', 'din bok', 'ditt hus', 'dina böcker'],
          ['our', 'vår bok', 'vårt hus', 'våra böcker'],
          ['your (more than one)', 'er bok', 'ert hus', 'era böcker'],
          ['his/her/their (fixed)', 'hans / hennes / hens / deras', 'hans / hennes / hens / deras', 'hans / hennes / hens / deras'],
    ...
    full: [
      'The my/your/our family agrees with the THING owned, not the owner: min bok (en), mitt kafé (ett), mina kompisar (plural). Same for din/ditt/dina, vår/vårt/våra and er/ert/era. Your homework correction "Mitt favoritkafé" is this rule.',
      'Er/ert/era is the one people forget, because English says "your" for one person and a crowd alike: Vad heter er mormor? Får jag spela på ert piano? Jag älskar era katter! Note that er is also the object form of ni (Jag vill bjuda er på middag), so the same word does two jobs.',
      'Hans, hennes, hens and deras never change form — they follow the OWNER, not the thing owned. Min syster Helen har en hund; hennes hund heter Max. Min bror Adam har en katt; hans katt heter Gosan. The noun\'s gender is irrelevant here, which is the exact opposite of how min/mitt/mina behaves. But they hide Swedish\'s most elegant trap: inside a sentence, when the owner IS the subject, you must switch to sin/sitt/sina.',
  ...
  {
    id: 'relative-som',
    title: 'som — joining two sentences',
    tag: 'Pronouns',
    hook: 'One little word glues two sentences into one — and it never changes.',
    cheat: [
      {
        kind: 'pattern',
        title: 'The move',
        slots: ['sentence 1', 'som', 'rest of sentence 2'],
        example: { sv: 'Jag har en faster som är yogainstruktör.', en: 'I have an aunt who is a yoga instructor.' },
      },
      {
        kind: 'pairs',
        title: 'Two sentences → one',
        items: [
          { sv: 'Jag har en kusin. Hon är skådespelare. → Jag har en kusin som är skådespelare.', en: 'hon disappears — som takes its place' },
          { sv: 'Miles har en hund. Den heter Nacho. → Miles har en hund som heter Nacho.', en: 'works for things too, not just people' },
          { sv: 'Liz lyssnar på en podd som är intressant.', en: 'som = who, that, which — one word for all three' },
        ],
      },
      { kind: 'note', text: 'The commonest mistake: keeping the old pronoun. ✗ Jag har en moster som hon är läkare. ✓ Jag har en moster som är läkare. Som IS the subject already.' },
      { kind: 'note', text: 'English drops "that" all the time ("the book I read"); Swedish can too when som is the OBJECT — boken (som) jag läste. But when som is the SUBJECT it can never be dropped.' },
    ],
    full: [
      'A relative pronoun is a word that stands in for something you already mentioned, so you can keep talking about it without starting a new sentence. Swedish has essentially one: som.',
      'That is a genuine gift. English forces you to choose between who, whom, which and that depending on whether you mean a person, a thing, a subject or an object. Swedish uses som for every one of those cases, and it never inflects — no gender, no number, no case.',
      'The mechanic is simple: take the second sentence, delete the pronoun that repeats the noun, and put som there instead. Jag har en farbror. Han är sjökapten. → Jag har en farbror som är sjökapten. The word som now does the job han was doing.',
      'That deletion is the step learners skip. Because English says "I have an aunt who is a doctor", it feels natural to translate word by word and produce "en moster som hon är läkare" — with both som and hon fighting for the same slot. Only one subject is allowed. Say it out loud with the pronoun removed until it stops feeling short.',
      'Som can also stand for an object, and there Swedish behaves like casual English: Boken som jag läste var bra, or just Boken jag läste var bra. Both are correct. When som is the subject, though, dropping it is impossible — there would be nothing left to run the verb.',
      'Do not confuse this som with the comparison som (lika bra som gamla filmer = as good as old films) or the "in the role of" som (Han jobbar som programmerare). Same spelling, different jobs; context makes it obvious.',
    ],
  },
  {
    id: 'da-adverb',
    title: 'DÅ-adverbs — "last Monday, last summer"',
    tag: 'Time',
    hook: 'i måndags, i somras, i julas — the -s that means "the one just gone".',
    cheat: [
      {
        kind: 'table',
        title: 'Add i … -s',
        columns: ['Type', 'Swedish', 'English'],
        rows: [
          ['Weekdays', 'i måndags, i tisdags … i söndags', 'last Monday … last Sunday'],
          ['Seasons', 'i våras, i somras, i höstas, i vintras', 'last spring/summer/autumn/winter'],
          ['Holidays', 'i julas, i påskas, i midsomras', 'last Christmas/Easter/midsummer'],
        ],
      },
      {
        kind: 'pairs',
        title: 'Past vs future — same day, opposite direction',
        items: [
          { sv: 'Var du på fest i lördags?', en: 'LAST Saturday — already happened', note: 'i + -s → past' },
          { sv: 'Ska du gå på fest på lördag?', en: 'THIS coming Saturday', note: 'på + plain day → future' },
          { sv: 'Natalia brukar gå på gym på tisdagar.', en: 'on Tuesdays, as a habit', note: 'på + plural' },
        ],
      },
      {
        kind: 'pattern',
        title: 'Front it and the verb jumps',
        slots: ['DÅ-adverb', 'VERB', 'subject', '…'],
        example: { sv: 'I måndags var jag i Stadshuset på fest.', en: 'Last Monday I was at a party at the City Hall.' },
      },
      { kind: 'note', text: 'A DÅ-adverb names a specific finished time, so the verb MUST be preteritum: I höstas hörde vi om Nobelpriset. Never a perfect — ✗ i höstas har vi hört.' },
    ],
    full: [
      'Swedish marks "the most recent one" with a little -s tacked onto a time word, preceded by i. I måndags is not "on Monday" — it is last Monday, the one that has already been and gone.',
      'The set is small and worth learning as a block: the seven weekdays (i måndags … i söndags), the four seasons (i våras, i somras, i höstas, i vintras) and the three big holidays (i julas, i påskas, i midsomras). Notice the seasons change shape a little — sommar becomes somras, höst becomes höstas, vinter becomes vintras.',
      'The pairing to keep straight is i lördags versus på lördag. Same weekday, opposite direction in time: i lördags points backwards, på lördag points forwards. Add the plural på lördagar and you get the third meaning, "on Saturdays" as a habit. Three forms, three different times — Natalia gick på gym i tisdags, Natalia ska gå på gym på tisdag, Natalia brukar gå på gym på tisdagar.',
      'Because a DÅ-adverb pins down one finished moment, the verb has to be in the simple past. This is the same instinct English has — "last summer I swam a lot", not "last summer I have swum" — but it is easy to forget once you have learned the Swedish perfect.',
      'These phrases love the front of the sentence, and that is where V2 bites: put the adverb first and the verb must still come second, which pushes the subject behind it. I våras köpte de en hund. I julas var det kallt. I påskas åt de mycket godis. If you catch yourself saying "I våras de köpte…", you have three elements before the verb and the sentence is broken.',
      'Everything above is about the past. For the future the pattern is different and simpler: på + the plain word — på lördag, på måndag, i sommar (this coming summer). The -s is the past-tense signal.',
    ],
  },
  {
    id: 'nagon-ingen',
    title: 'någon / ingen — some, any, none',
    tag: 'Pronouns',
    hook: 'ingen is just a shortcut for inte någon — and both agree en/ett/plural.',
    cheat: [
      {
        kind: 'table',
        title: 'Both sets agree with the noun',
        columns: ['', 'en-word', 'ett-word', 'plural'],
        rows: [
          ['some / any', 'någon', 'något', 'några'],
          ['no / none', 'ingen', 'inget', 'inga'],
          ['spoken as', 'nån', 'nåt', 'nåra'],
        ],
      },
      {
        kind: 'pairs',
        title: 'The equation',
        items: [
          { sv: 'Jag har ingen bil. = Jag har inte någon bil.', en: 'ingen = inte + någon, contracted', note: 'both correct' },
          { sv: 'Har du några syskon? — Nej, jag har inga syskon.', en: 'några in the question, inga in the answer' },
          { sv: 'Har vi något bröd hemma?', en: 'ett bröd → något' },
        ],
      },
      { kind: 'note', text: 'Use någon/något/några when it does not matter WHICH one: Har du någon cykel? — Ja, en röd mountainbike. Any bike will do for the question.' },
      { kind: 'note', text: 'några can also just mean "a few, two or three": Jag måste köpa några saker.' },
      { kind: 'note', text: 'Agreeing with a negative uses heller, not också: Jag behöver inga nya böcker. — Inte jag heller. ("Me neither.")' },
    ],
    full: [
      'These two words cover a lot of English at once. Någon/något/några is some, any, someone, something and a few; ingen/inget/inga is no, none, nobody and nothing. Both sets agree with the noun exactly like an adjective: en-word, ett-word, plural.',
      'The single most useful fact is that they are the same word. Ingen is simply inte någon squeezed together. Jag har ingen bil and Jag har inte någon bil mean precisely the same thing, and you can always fall back on the longer version if the short one will not come to mind.',
      'Reach for någon when the identity does not matter. Har du någon cykel? asks whether you have a bike at all — any bike. Jag vill gärna ha någon deckare means some crime novel or other, not one particular title. That vagueness is the whole point of the word.',
      'Några has a second everyday meaning: a small number, two or three. Jag måste köpa några saker. Jag drömmer om några vackra gardiner. Context tells you whether it is "any" or "a few", and usually it does not matter much.',
      'In speech these are almost never pronounced as written. Nån, nåt and nåra are what you will actually hear, and you can write them that way in a text message — but keep någon/något/några in anything formal.',
      'One small trap when agreeing with someone: English says "me too" and "me neither" with the same "me". Swedish switches the second word. Positive → Jag också. Negative → Inte jag heller. Jag behöver inga nya böcker. — Inte jag heller.',
    ],
  },
];
